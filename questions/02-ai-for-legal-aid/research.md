...
5. Transfer this case to a legal aid officer during the interaction if one is available. Ongoing reported violence, deprivation, a child in the household and absent survivor consent justify prompt human review even without proof of an emergency. The AI can arrange a safe follow-up only under an approved protocol; it cannot promise a response time unsupported by staffing.
